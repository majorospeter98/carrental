  ...
  <div class="container mt-5">
    ...
    <form @submit.prevent="searchAvailableCars" class="row g-3 mb-5">
      ...
      <div class="col-md-6">
        ...
        <input type="date" class="form-control" v-model="endDate" required :min="startDate">
      </div>
...
export default {
  ...
  methods: {
    ...
    openImage(id) {
     ...
     useCarStore().startDate= this.startDate; // Saving the start + enddate, so I can use at Renst.vue
